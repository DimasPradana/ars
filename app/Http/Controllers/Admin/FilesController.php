...
class FilesController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($roleId == 2 && $userFilesCount > 50000) {
        ...
        if (!Gate::allows('file_create')) {
            ...
            foreach ($fileIds as $fileId) {
                $file = File::create([
					...
					'archiveNumbers' => $request->input('archiveNumbers'),
	...
	public function edit($id)
	{
		...
		$created_bies = \App\File::get()->pluck('caption', 'archiveNumbers', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
    ...
    public function update(Request $request, $id)
    {
		...
		// $request->updateMedia($media, 'filename')->toMediaCollection();

		// TODO dimas updateMedia belum ketemu
		// dd($media);
		return redirect()->route('admin.files.index');
    }
